    ...
    <SafeAreaView style={styles.screen} edges={["top", "left", "right"]}>
      {isIpad ? (
        <RecipeBooksSplitView
          ...
          bookEmoji={state.bookEmoji}
          bookError={state.bookError}
          renameError={state.renameError}
          hasHousehold={state.hasHousehold}
          ...
          onBookEmojiChange={state.onBookEmojiChange}
          onIsSharedChange={state.onIsSharedChange}
          onCreateBook={state.handleCreateBook}
          onRenameBook={state.handleRenameBook}
          onUpdateBookEmoji={state.handleUpdateBookEmoji}
          onUpdateBookSharing={state.handleUpdateBookSharing}
